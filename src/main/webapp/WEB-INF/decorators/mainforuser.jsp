  ...
  <body>
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="navbar-header">
			<a class="navbar-brand" href="<%=request.getContextPath()%>/back/users" style="font-family:Impact; font-weight:bolder; font-size:25px;color:#1cb394;">
			JKZY&nbsp;后台管理系统</a>
  		</div>    
        <div class="collapse navbar-collapse">
        	...
        	<ul class="nav navbar-nav navbar-right">
      			...
      			<li><a>当前登陆:${loginAdmin.account}[${role.roleName}]</a></li>
              ...
              <div class="panel panel-default" style="border-radius:0;">
                ...
                <div id="collapse3" class="panel-collapse collapse in">
                  <div class="panel-body">
                   	<ul>
                  		<li style="border-bottom:1px solid #1cb394"><a href="<%=request.getContextPath()%>/user/hospital/hospitals">医院资料</a></li>
                        <li ><a href="<%=request.getContextPath()%>/user/doctor/doctors">在职医生资料</a></li>
                    </ul>      
                  </div>
                </div>
              </div>
