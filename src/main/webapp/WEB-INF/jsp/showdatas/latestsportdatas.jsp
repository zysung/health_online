  		...
  		<c:if test="${pager.total gt 0}" >
  			<c:forEach items="${pager.datas}" var="sportdata" varStatus="status">			
  				<tr>
  					...
  					<td><a href="<%=request.getContextPath()%>/showdatas/${sportdata.userAccount}/usersportdatas">查看该用户全部运动数据</a></td>
  				</tr>
  			</c:forEach>
 			<tr>
				<td colspan="10" align="right">
					<jsp:include page="/inc/pager.jsp">
						<jsp:param value="latestsportdatas" name="url"/>
