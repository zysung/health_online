...
<div class="container">
  		<div class="row">
        <div class="col-lg-8">
		  <sf:form method="post"   modelAttribute="hospital"  class="form-horizontal"  enctype="multipart/form-data">
		  			<div class="form-group">
                        ...
                        <div class="col-lg-5">
							...
							<c:choose>
							  <c:when test="${hospital.logo ne null }"><img id=“previewImg” src="logo"  height="150" width="150" style="box-shadow:0px 0px 12px #7E7E7E;"/></c:when>
		            ...
		            <div class="form-group" >
			  		...
			  		<div class="form-group">
                            <div class="col-lg-9 col-lg-offset-3">
	                             <input type="submit" class="btn btn-primary" value="更改医院信息">
