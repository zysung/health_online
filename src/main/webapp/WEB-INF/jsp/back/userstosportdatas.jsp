...
<html>
  ...
  <body>
  	<form action="userstosportdatas"  method="get"  class="form-inline">
  		...
  		<c:if test="${pager.total gt 0}" >
  			<c:forEach items="${pager.datas }" var="user" varStatus="status">			
  				<tr>
  					...
  					<td>${user.account }</td>
  					<td>${user.name }</td>
  					<td><a href="${user.account}/latestsportdata">查看最新运动数据</a>
  						&nbsp;&nbsp;&nbsp;&nbsp;
  						<a href="${user.account}/sportdatas" >查看所有运动数据</a>
  					</td>
  				</tr>
  			</c:forEach>
 			<tr>
				<td colspan="10" align="right">
					<jsp:include page="/inc/pager.jsp">
						<jsp:param value="userstosportdatas?condition=${condition}&&" name="url"/>
